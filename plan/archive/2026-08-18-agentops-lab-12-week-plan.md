...
> Archive 사유: 2026-08-18 심화과정의 우선 목표를 제품 완성에서 선택형 기술 학습으로 변경하면서 현재 계획에서 제외했다. AgentOps Lab은 과정 핵심 학습을 마친 뒤 시간이 남을 때 별도 프로젝트로 재개한다.
> 현재 학습 계획: [심화과정 12주 학습 계획](../advanced-track-12-week-plan.md)

> 작성일: 2026-08-18
> 상태: Archived — 대체됨
> 최근 개정: 2026-08-18 — 일정·학습 계획과 제품 시스템 설계의 기준 문서 분리
> 대체한 문서: [초기 심화과정 학습 계획](./2026-07-29-initial-advanced-track-plan.md)
...
| 각 주에 무엇을 학습·구현·검증하는가? | [12주 주차별 Roadmap](./2026-08-18-agentops-lab-weekly-roadmap.md) |
| WIL과 기술 블로그를 어떻게 작성하는가? | [학습 및 기술 콘텐츠 계획](./2026-08-18-agentops-lab-learning-and-content-plan.md) |
...
상세 학습, 구현, 산출물과 완료 조건은 [12주 주차별 Roadmap](./2026-08-18-agentops-lab-weekly-roadmap.md)에 있다.
...
상세 원칙과 12주 콘텐츠 Backlog는 [학습 및 기술 콘텐츠 계획](./2026-08-18-agentops-lab-learning-and-content-plan.md)에 있다.
...
- [12주 주차별 Roadmap](./2026-08-18-agentops-lab-weekly-roadmap.md)
- [학습 및 기술 콘텐츠 계획](./2026-08-18-agentops-lab-learning-and-content-plan.md)
- [현재 계획 문서 안내](../README.md)
- [초기 심화과정 학습 계획](./2026-07-29-initial-advanced-track-plan.md)
